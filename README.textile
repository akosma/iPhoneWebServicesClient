...
* "AFNetworking":https://github.com/gowalla/AFNetworking - a very fast, NSOperation-based networking library
* "NextiveJSON":https://github.com/nextive/NextiveJson - a very fast JSON parsing library
* "ASIHTTPRequest":http://allseeing-i.com/ASIHTTPRequest - wrapper around the CFNetwork API, no longer maintained
