...
SYMID cocoa_syck_parse_handler(SyckParser *p, SyckNode *n)
{
    ...
    switch ( n->kind )
    {
        case syck_str_kind:
            ...
            {
				v = [NSString stringWithUTF8String:n->data.str->ptr];
            }
			...
			{
				v = [NSData dataWithBase64EncodedString:[NSString stringWithUTF8String:n->data.str->ptr]];
            }
...
//            {
//                v = [NSDate dateWithNaturalLanguageString:[NSString stringWithUTF8String:n->data.str->ptr]];
//            }
